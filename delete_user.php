...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // If the form is submitted, delete the user record
        ...
        if (mysqli_query($conn, $query)) {
            ...
            header('Location: ../admin.php?error=Error deleting user: ' . mysqli_error($conn));
            exit;
        }
    } else {
        ...
        <body>
            <div class='container mt-5'>
                ...
                <form method='POST' action='delete_user.php?id=$id'>
